...
\
    ...
    \} catch (error) \{\
      console.error(error);\
      alert('\uc0\u1581 \u1583 \u1579  \u1582 \u1591 \u1571  \u1571 \u1579 \u1606 \u1575 \u1569  \u1581 \u1601 \u1592  \u1575 \u1604 \u1593 \u1605 \u1610 \u1604 ');\
    \} finally \{\
...
\
  return (\
    <div className="max-w-2xl mx-auto">\
      <h1 className="text-white text-2xl font-bold mb-6">\uc0\u1573 \u1590 \u1575 \u1601 \u1577  \u1593 \u1605 \u1610 \u1604  \u1580 \u1583 \u1610 \u1583 </h1>\
      \
...
\
        <div className="flex items-center gap-3 pt-4">\
          <button type="submit" disabled=\{isSubmitting\} className="flex-1 bg-cyan-400 text-black font-bold py-3 rounded-xl hover:bg-cyan-300 transition-colors disabled:opacity-50 flex items-center justify-center gap-2">\
            \{isSubmitting ? <LoadingSpinner size="sm" /> : '\uc0\u1581 \u1601 \u1592  \u1575 \u1604 \u1593 \u1605 \u1610 \u1604 '\}\
          </button>\
